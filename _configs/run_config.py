...
pre_calibration_run_path = f"_pre_calibration_population_growth_rate_validation_{run_name}"
...
calibration_path = f"{calibration_runs_path}/calibration_{run_name}_{calibration_population_scale}_population_scale_{SEASONALLITY_MODE}_pattern_{calibration_replicates}_replicates"
...
validation_path = f"{validation_runs_path}/validation_{run_name}_{validation_population_scale}_population_scale_{SEASONALLITY_MODE}_pattern_{validation_replicates}_replicates"
